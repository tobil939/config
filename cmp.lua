    ...
    config = function()
      ...
      cmp.setup({
        mapping = cmp.mapping.preset.insert({
          ...
          ['<C-Space>'] = cmp.mapping.complete(), -- Manuelles Auslösen der Autovervollständigung
          ['<C-e>'] = cmp.mapping.abort(), -- Abbrechen
          ['<CR>'] = cmp.mapping.confirm({ select = true }), -- Bestätigen der Auswahl
        }),
