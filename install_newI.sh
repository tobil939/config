...
sudo cp mnt2.sh /home/$user_name/Scripts/mnt2.sh >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE" # mnt2.sh
cd /home/$user_name/Scripts
sudo chmod +x mnt2.sh >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE" # mnt2.sh ausführbar machen

cd /home/$user_name/git1/config >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE"
notify-send "bash wird erstellt für bluetooth"
if [ -f /home/$user_name/Scripts/bluetooth.sh ]; then
  sudo rm /home/$user_name/Scripts/bluetooth.sh
fi
sudo cp bluetooth.sh /home/$user_name/Scripts/bluetooth.sh
cd /home/$user_name/Scripts
sudo chmod +x bluetooth.sh >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE" # bluetooth.sh ausführbar machen

cd /home/$user_name/git1/config >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE"
notify-send "bash wird erstellt für Updates"
if [ -f /home/$user_name/Scripts/update.sh ]; then
  sudo rm /home/$user_name/Scripts/update.sh
fi
sudo cp bluetooth.sh /home/$user_name/Scripts/update.sh
cd /home/$user_name/Scripts
sudo chmod +x update.sh >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE" # update.sh ausführbar machen
cd /home/$user_name/ >>"$LOG_FILE" 2>>"$ERROR_LOG_FILE"
